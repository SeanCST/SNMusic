...
//    [playPauseBtn setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
//    [playPauseBtn setTitleColor:[UIColor redColor] forState:UIControlStateHighlighted];
